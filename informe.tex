...
\begin{itemize}
	...
	\item \auxil{pixelV\acute{a}lido(p : Pixel) : Bool}{(prm(p) \geq 0) \ \land \ (prm(p) < 256) \ \land \ (sgd(p) \geq 0) \ \land \ (sgd(p) < 256) \ \land \ (ter(p) \geq 0) \ \land \ (ter(p) < 256)}
	...
	\item \auxil{mismoTama\tilde{n}o(a,b:Imagen) : Bool}{ 
		 imagenV\acute{a}lida(a)\ \land \ imagenV\acute{a}lida(b)\ \land \ (ancho(a)==ancho(b)) \ \land \ alto(a)==alto(b))}
